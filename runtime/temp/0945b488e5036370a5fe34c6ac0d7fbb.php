<?php /*a:3:{s:43:"D:\phpEnv\www\cz_pay\view\admin\user_t.html";i:1728643364;s:50:"D:\phpEnv\www\cz_pay\view\layout\admin_header.html";i:1728714339;s:50:"D:\phpEnv\www\cz_pay\view\layout\admin_footer.html";i:1728668888;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                <a type="button" class="btn btn-sm btn-light btn-light-primary" href="<?php echo getConfig('backstage_entrance'); ?>/user">返回列表</a>
            </div>
        </div>
    ...
    var KTDatatablesServerSide = function () {
        ...
        var initDatatable = function () {
            dt = $("#kt_datatable_example_1").DataTable({
                ...
                stateSave: true,
                ajax: {
                    url: "<?php echo getConfig('backstage_entrance'); ?>/user_t_list?uid=<?php echo htmlentities((isset($_REQUEST['uid']) && ($_REQUEST['uid'] !== '')?$_REQUEST['uid']:'')); ?>",
                },
                columns: [
                    { data: 'id' },
                    { data: 'avatar' },
